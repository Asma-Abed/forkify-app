...
var _showResultsViewJs = require("./views/showResultsView.js");
var _showResultsViewJsDefault = parcelHelpers.interopDefault(_showResultsViewJs);
...
const controlRecipes = async ()=>{
    try {
        ...
        (0, _showResultsViewJsDefault.default).update(_modelJs.getSearchResultsPage());
        // update bookmarks
...
const conrtolLoadSearch = async function() {
    try {
        ...
        if (!query) return;
        (0, _showResultsViewJsDefault.default).renderSpinner();
        // load search results
        await _modelJs.loadSearchResults(query);
        // render search results
        // showResultsView.render(model.state.search.results);
        (0, _showResultsViewJsDefault.default).render(_modelJs.getSearchResultsPage());
...
const controlPagination = function(goToPage) {
    ...
    (0, _showResultsViewJsDefault.default).render(_modelJs.getSearchResultsPage(goToPage));
...
const controlAddBookmark = function() {
    ...
    if (!_modelJs.state.recipe.bookmarked) _modelJs.addBokkmark(_modelJs.state.recipe);
...
const controlAddREcipe = async function(newRecipe) {
    try {
        ...
        // showe new ID is url
        window.history.pushState(null, "", `#${_modelJs.state.recipe.id}`)// render bookmark view
...
const init = function() {
    (0, _bookmarksViewJsDefault.default).addHanlerRender(controlBookmarks);
    (0, _recipeViewJsDefault.default).addHandlerRender(controlRecipes);
    (0, _recipeViewJsDefault.default).addHandlerUpdateServings(controlServings);
    (0, _recipeViewJsDefault.default).addHandlerAddBookmark(controlAddBookmark);
    (0, _searchViewJsDefault.default).addHandlerSearch(conrtolLoadSearch);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddREcipe);
};
init();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeView.js":"l60JC","regenerator-runtime":"dXNgZ","./views/searchView.js":"9OQAM","./views/showResultsView.js":"iPZF2","core-js/modules/es.array.includes.js":"dkJzX","core-js/modules/web.immediate.js":"49tUX","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs"}],"gkKU3":[function(require,module,exports) {
...
parcelHelpers.export(exports, "addBokkmark", ()=>addBokkmark);
...
const addBokkmark = function(recipe) {
    // add bookmark
...
const KEY = "d9e7d4fc-86da-404e-bd18-5cf23a32e0b5";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iPZF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ShowResultsView extends (0, _viewJsDefault.default) {
...
exports.default = new ShowResultsView();

},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view.js":"bWlJ9","./previewView.js":"1FDQ6"}],"1FDQ6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dkJzX":[function(require,module,exports) {
"use strict";
...
},{"./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2kSJi","aenu9"], "aenu9", "parcelRequire3a11")
